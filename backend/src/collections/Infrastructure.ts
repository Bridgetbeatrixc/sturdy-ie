...
export const Infrastructure: CollectionConfig = {
    ...
    admin: {
        ...
        livePreview: {
            url: () => `${process.env.NEXT_PUBLIC_SITE_URL ?? 'http://localhost:3000'}/#infrastructure`,
        },
        preview: () =>
            `${process.env.NEXT_PUBLIC_SITE_URL ?? 'http://localhost:3000'}/#infrastructure`,
    },
    access: {
        read: () => true,
        create: () => true,
    ...
    fields: [
        ...
        },
        {
            ...
            type: 'text',
            required: true,
            defaultValue: 'Building Infrastructure',

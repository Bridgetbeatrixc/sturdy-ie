      ...
      <section className="border-b border-zinc-900/60 bg-black">
        <div className="mx-auto max-w-6xl px-4 py-16 sm:px-6 md:px-10 md:py-20 lg:px-0">
          ...
          <p className="mt-4 max-w-2xl text-sm leading-relaxed text-zinc-300">
            Share a brief outline of your initiative, the stakeholders involved,
            and any specific governance or regulatory constraints. I’ll respond
            with potential next steps and collaboration options.
          </p>
        </div>
      </section>
      <FooterSection />

...
export function HeroSection({ data }: Props) {
  ...
  // Fall back to hardcoded values if CMS document hasn't been created yet
  ...
  const description       = data?.description      ?? "I design systems and operating models that enable organisations to use data in practice, translating policy, regulation, and governance into infrastructure that is secure, usable, and trusted.";

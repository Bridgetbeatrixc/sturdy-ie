export function HomeAboutSection() {
  return (
    <section className="relative overflow-visible md:justify-center mx-auto flex max-w-8xl flex-col md:flex-row gap-30 py-8 md:px-6 md:py-16">
        {/* Hero Profile Card */}
        ...
        style={{ opacity: 0, animation: 'fadeUp 0.8s ease-out 0.2s forwards' }}>
          ...
          <h2 className="text-3xl px-8 leading-tight text-white md:text-5xl">
            Current Areas of <span className="text-[#c5f018] font-semibold">Work</span>
          </h2>
        </div>

        {/* About paragraphs */}
        <div className="px-16 space-y-4 text-[0.95rem] leading-relaxed text-zinc-300">
          <p className="text-lg">

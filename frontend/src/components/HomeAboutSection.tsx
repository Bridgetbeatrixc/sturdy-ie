...
export function HomeAboutSection() {
  ...
  return (
    <section
      ref={ref}
      className="relative overflow-visible md:justify-center mx-auto flex max-w-8xl flex-col md:flex-row gap-8 py-8 md:py-16"
    >
      {/* Hero Profile Card */}
      <div
        className="space-y-5"
      ...
      >
        <div className="flex items-center gap-2 px-8">
          ...
          />
          <span className="text-sm md:text-lg text-white">Focus</span>
        </div>
      ...
      {/* About paragraphs */}
      <div
        className="px-4 md:px-0 space-y-4 text-[0.95rem] leading-relaxed text-zinc-300"
        style={{
          opacity: visible ? undefined : 0,
          animation: visible ? 'fadeUp 2s forwards' : 'none',
        }}

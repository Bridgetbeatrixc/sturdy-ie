...
const ICON_MAP: Record<ExpertiseItem["icon"], ReactNode> = {
...
type Props = { data: ChallengeData };

export function ExpertiseSection({ data }: Props) {
      ...
      <div className="mx-auto max-w-8xl md:px-4 lg:px-4">
        <div className="flex flex-col lg:flex-row gap-10 lg:gap-20">
          ...
          <div className="w-full lg:w-1/2">
            ...
            <SplitHeading heading={data.heading} highlight={data.headingHighlight} />
            ...
            <div className="mt-10 grid gap-4 grid-cols-2">
              {data.expertiseItems.map((item, i) => (
                <article
                  key={item.title}
                  ...
                  style={{
                    opacity: 0,
                    animation: visible
                      ? `fadeUp 1.5s ease-out ${0.2 + i * 0.3}s forwards`
                      : "none",
                  }}
                >
                  <div
          ...
          <div className="w-full lg:w-1/2 space-y-6">
            <div
              ...
              style={{
                opacity: 0,
                animation: visible
                  ? "slideUpReveal 1.2s cubic-bezier(0.22, 1, 0.36, 1) 0.2s forwards"
                  : "none",
              }}
            >
              <div
                className="h-64 sm:h-80 md:h-96 lg:h-[500px] xl:h-[700px] w-full bg-cover bg-center"
